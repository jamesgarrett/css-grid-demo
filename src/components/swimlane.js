      ...
      return(
        ...
        <section className="list swimlane-container p-y p-lg">
          ...
          <ul className="swimlane p-l p-md">
            ...
            <li className="card img-poster img-sm img-shield">
              <img src="https://dimages.amcnetworks.com/fit-in/400x600/filters:quality(75):format(jpg)/images.amcnetworks.com/amc.com/wp-content/uploads/2020/03/killing-eve-S3-season-3-key-art-400x600.jpg" alt="show name"></img>
            </li>
            <li className="card img-poster img-sm img-shield">
              <img src="https://dimages.amcnetworks.com/fit-in/400x600/filters:quality(75):format(jpg)/images.amcnetworks.com/amc.com/wp-content/uploads/2020/05/bottomless-brunch-at-colmans-400x600.jpg" alt="show name"></img>
            </li>
            <li className="card img-poster img-sm img-shield">
              <img src="https://dimages.amcnetworks.com/fit-in/400x600/filters:quality(75):format(jpg)/images.amcnetworks.com/amc.com/wp-content/uploads/2020/09/eli-roth-history-of-horror-s2-season-2-key-art-400x600-logo.jpg" alt="show name"></img>
            </li>
            <li className="card img-poster img-sm img-shield">
              <img src="https://dimages.amcnetworks.com/fit-in/400x600/filters:quality(75):format(jpg)/images.amcnetworks.com/amc.com/wp-content/uploads/2014/06/04_BCS-S5_400x600_ShowPoster_withLogo.jpg" alt="show name"></img>
            </li>
          </ul>
        </section>
